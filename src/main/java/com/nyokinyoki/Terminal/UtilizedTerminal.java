...
public class UtilizedTerminal {
    ...
    static {
        ...
        CLIArg getAvaliableCoursesByTimeSlotCLI = new CLIArg("<DAY_OF_WEEK>曜日(月：1, 金曜：5)の<BEGINNING_PERIOD>コマにある授業を表示",
    ...
    private Completer createCompleter() {
        ...
        stampOptions.forEach(option -> syllabusWidgetOpts.put(option.getArg(), option.getDesc()));
